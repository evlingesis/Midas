...
### 2.3. Коли і як виставляється `qty_producing`

`qty_producing` — це поле «скільки **фактично** виробляється цим MO». На формі видно як `0 / N` де N — план.

- **На стані Підтверджено:** 0. Ще не починали.
- **При натисканні «Початок»:** Odoo автоматично виставляє `qty_producing = product_qty` (план). Тобто «починаємо виробляти всі заплановані 150 шт».
- **При натисканні «Виготовити все» з Підтверджено:** теж auto-fill з плану.
- **Можна редагувати вручну.** Наприклад, виставити 100 шт замість 150. Тоді при Validate Odoo запропонує створити **backorder** — окреме MO на залишок 50 шт. Корисно коли реально виробили менше, ніж планували (наприклад, тканини на 50 шт забракло).

Сценарій з життя: «Запланували 150, виготовили 130, ще 20 завтра». Виставляєте 130 у `qty_producing`, тиснете «Виготовити все», Odoo пропонує backorder → на завтра з'явиться MO на 20 шт.
